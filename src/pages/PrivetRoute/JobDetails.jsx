...
import { FaFacebook, FaLinkedin, FaMapMarkerAlt, FaPhone, FaPinterest, FaTwitter } from 'react-icons/fa';
...
const JobDetails = () => {
    ...
    console.log(details)
    const {company, location , position , job_type , skills , salary}  = details || {};
    // 
    useEffect(()=>{
    ...
    <div className='w-11/12 mx-auto space-y-8'>
        <div className="flex items-center justify-between bg-gray-50 border border-gray-200 p-5 rounded-lg shadow-md">
    ...
    {/*  */}
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md border border-gray-200">
          ...
          <p className="text-gray-600 mb-4">
            ...
            a more-or-less normal distribution of letters, as opposed to using content publishing packages.
          </p>
          ...
          <ul className="list-disc list-inside text-gray-600 space-y-2">
            <li>Having approved themes on ThemeForest will be given high preference.</li>
            <li>Strong knowledge of WordPress Theme Standards.</li>
            <li>Ability to convert HTML templates into fully functional WordPress themes.</li>
            <li>Good knowledge in OOP PHP and front-end technologies like HTML, CSS, JS, jQuery.</li>
            <li>Moderate knowledge in WordPress Core APIs like options, metadata, REST, hooks, settings, etc.</li>
            <li>Ability to debug and fix bugs arising from other developer's code.</li>
          </ul>

          <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-4">Educational Requirements</h3>
          <p className="text-gray-600">
            It doesn’t matter where you went to college or what your CGPA was as long as you are
            smart, passionate, ready to work hard, and have fun.
          </p>
        </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-md border border-gray-200">
          ...
          <ul className="text-gray-600 space-y-3">
            ...
            <li><strong>Posted:</strong> 20 June, 2022</li>
            <li><strong>Salary:</strong> {salary}</li>
            <li><strong>Experience:</strong> 5 Years</li>
            <li><strong>Gender:</strong> Male or Female</li>
            <li><strong>Qualification:</strong> BSC, MSC</li>
            <li><strong>Level:</strong> Senior</li>
            <li><strong>Applied:</strong> 26 Applicants</li>
            <li><strong>Application End:</strong> <span className="text-red-500">20 November, 2022</span></li>
          </ul>

          {/* Share */}
          <div className="mt-6">
            <h4 className="text-lg font-semibold text-gray-800 mb-3">Share With</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md border border-gray-200">
          ...
          {/* Statement */}
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Statement</h2>
          <p className="text-gray-600 mb-6">
            Finate is committed to creating the happiest company working for and is proud to provide
            equal opportunity to all. All the qualified applicants will receive consideration for
            employment without regard to race, color, ancestry, religion, sex, sexual orientation,
            age, citizenship, marital status, disability, gender identity, or any other basis
            protected by federal, state, or local law.
          </p>

          {/* Apply Now Button */}
          <button className="w-full py-3 bg-green-500 text-white font-medium rounded-lg hover:bg-green-600">
            Apply Now
          </button>
        </div>
